...
/*   Updated: 2024/04/16 18:03:46 by rcutte           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string input_name)
  : name_(input_name),
    ...
    energy_point_(10),
    attack_dmg_(0){
  std::cout << BLUB << "Constructor of ClapTrap param Called" << RESET << "\n";
}
...
{
  *this = obj;
  std::cout << CYNB << "Constructor by copy of ClapTrap Called" << RESET << "\n";
}

ClapTrap::~ClapTrap(){
  std::cout << BLKHB << "Destructor of ClapTrap Called" << RESET << "\n";
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &rhs){
  ...
  std::cout << CYNB << "Constructor by assign of ClapTrap Called" << RESET << "\n";
  return *this;
}
