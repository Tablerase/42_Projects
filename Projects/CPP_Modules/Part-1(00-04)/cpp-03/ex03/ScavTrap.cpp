...
/*   Updated: 2024/04/16 22:38:21 by rcutte           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ScavTrap.hpp"

ScavTrap::ScavTrap() : ClapTrap("NoNameScav", 100, 50, 20), energy_point_(50) {
...
ScavTrap::ScavTrap(std::string name) : ClapTrap(name, 100, 50, 20), energy_point_(50) {
...
ScavTrap::ScavTrap(
  ...
  int energy_point, 
  int attack_dmg)
  : ClapTrap(name, hitpoint, energy_point, attack_dmg), energy_point_(50) {
